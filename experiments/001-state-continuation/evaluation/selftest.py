...
GT = json.loads(
    (HERE.parent / "dataset" / "tasks" / "task_001_vendor_selection"
...
def main() -> int:
    ...
    check("proposal guard (re-proposal flagged)", s_re["M6_repeated_work_hits"] == ["R1"],
