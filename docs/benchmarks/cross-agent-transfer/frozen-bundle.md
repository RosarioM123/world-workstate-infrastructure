# FROZEN TRANSFER BUNDLE

**Frozen:** 2026-09-21 · **Source:** `docs/experiment-002/handoff-y.md` (the WORLD-state condition handoff from experiment #002, blind code Y).
**Do not edit.** This is the exact bundle a transfer-test runner receives. Scoring key: `answer-key.md` (sealed from the runner).
